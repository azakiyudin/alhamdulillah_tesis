...
% \begin{defn}
%     Diberikan $(X,d,G)$ adalah ruang $CAT _p(0)$. Suatu himpunan bagian $\mathcal{M}\subseteq X$ disebut kompak jika setiap barisan di $\mathcal{M}$ memiliki subbarisan yang konvergen ke suatu titik di $\mathcal{M}$.
% \end{defn}
% \begin{exam}
