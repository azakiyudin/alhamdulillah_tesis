...
\begin{defn}
    Misalkan $W$ adalah himpunan yang tertutup dan konveks dari suatu ruang Banach, $x_0\in W$, serta $T:W\to W$ adalah suatu pemetaan nonekspansif. Barisan $\{x_k\}$ yang dihasilkan oleh skema iterasi Mann didefinisikan sebagai
\begin{align}
        x_{k+1} &= (1-a_k)x_k +a_k Tx_k,
\end{align}
dengan $\{a_k\}\subseteq (0,1]$.
\end{defn}
Berbagai perkembangan skema iterasi juga terus bermunculan hingga saat ini dengan salah satu tujuannya adalah mencari skema iterasi yang tercepat untuk aproksimasi titik tetap dari suatu pemetaan. Untuk selanjutnya, berikut ini diberikan skema iterasi yang konvergen ke titik tetap dari pemetaan nonekspansif diperumum di ruang Banach.
\begin{defn}\cite{agarwal}
    Misalkan $W$ adalah himpunan yang tertutup dan konveks dari suatu ruang Banach, $x_0\in W$, serta $T:W\to W$ adalah suatu pemetaan nonekspansif. Barisan $\{x_k\}$ yang dihasilkan oleh skema iterasi Agarwal didefinisikan sebagai
    ...
    \end{cases}
\end{align}
dengan $\{a_k\},\{b_k\}\subseteq (0,1)$.
\end{defn} 
\begin{defn}\cite{abbas}
    Misalkan $W$ adalah himpunan yang tertutup dan konveks dari suatu ruang Banach, $x_0\in W$, serta $T:W\to W$ adalah suatu pemetaan nonekspansif. Barisan $\{x_k\}$ yang dihasilkan oleh skema iterasi Abbas didefinisikan sebagai
    ...
    \end{cases}
\end{align}
dengan $\{a_k\},\{b_k\},\{c_k\}\subseteq (0,1)$.
\end{defn}
\begin{defn}\cite{Thakur2016}
    Misalkan $W$ adalah himpunan yang tertutup dan konveks dari suatu ruang Banach, $x_0\in W$, serta $T:W\to W$ adalah suatu pemetaan nonekspansif yang memenuhi kondisi $(C)$. Barisan $\{x_k\}$ yang dihasilkan oleh skema iterasi Thakur didefinisikan sebagai
...
dengan $\{a_k\},\{b_k\},\{c_k\}\subseteq (0,1)$.
\end{defn}
\begin{defn}\cite{Ahmad2021}
    Misalkan $W$ adalah himpunan yang tertutup dan konveks dari suatu ruang Banach, $x_0\in W$, serta $T:W\to W$ adalah suatu pemetaan nonekspansif tipe Reich-Suzuki. Barisan $\{x_k\}$ yang dihasilkan oleh skema iterasi JK didefinisikan sebagai
    ...
    \end{cases}
\end{align}
dengan $\{a_k\},\{c_k\}\subseteq (0,1)$.
\end{defn}
\begin{defn}\cite{sabri2025}
    Misalkan $W$ adalah himpunan yang tertutup dan konveks dari suatu ruang Banach, $x_0\in W$, serta $T:W\to W$ adalah suatu pemetaan nonekspansif tipe Reich-Suzuki. Barisan $\{x_k\}$ yang dihasilkan oleh skema iterasi Sabri didefinisikan sebagai
