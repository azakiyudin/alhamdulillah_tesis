...
\begin{equation}
    \|Tx-Ty\|\leq c\|x-y\|
\end{equation}
untuk setiap $x,y\in W$, maka pemetaan $T$ mempunyai tepat satu titik tetap \cite{Banach1922}. Jika konstanta $c$ boleh bernilai 1, pemetaan tersebut dinamakan pemetaan nonekspansif. Pemetaan ini merupakan perluasan dari pemetaan kontraktif yang memainkan peranan penting dalam teori titik tetap, terutama dalam memastikan eksistensi serta konvergensi solusi dari berbagai permasalahan. Namun, berbeda dengan pemetaan kontraktif, pemetaan nonekspansif tidak selalu mempunyai titik tetap yang tunggal. Selain itu, terdapat syarat cukup untuk keberadaan titik tetap pada kelas pemetaan ini, yaitu jika $W$ merupakan himpunan bagian tertutup dan terbatas dari ruang Banach konveks seragam \cite{Browder1965}. 
...
Dari latar belakang yang telah dipaparkan sebelumnya, fokus penelitian ini dirumuskan sebagai berikut:
\begin{enumerate}
