...
\begin{enumerate}
\item Bagaimana konvergensi dari skema iterasi Sabri di ruang $CAT_p(0)$ untuk pemetaan nonekspansif $(\alpha,\beta,\gamma)$-nonekspansif?
\item Bagaimana laju konvergensi dari skema iterasi Sabri untuk pemetaan $(\alpha,\beta,\gamma)$-nonekspansif dibanding dengan skema iterasi lainnya secara numerik?
...
\begin{enumerate}
   \item Mendapatkan hasil konvergensi dari skema iterasi Sabri di ruang $CAT_p(0)$ untuk pemetaan $(\alpha,\beta,\gamma)$-nonekspansif.
\item Mengetahui laju konvergensi dari skema iterasi Sabri untuk $(\alpha, \beta,\gamma)$-nonekspansif diperumum dibanding dengan skema iterasi lainnya secara numerik.
...
\begin{enumerate}
    ...
    \item Sebagai alternatif penyelesaian masalah optimasi. 
\end{enumerate}
