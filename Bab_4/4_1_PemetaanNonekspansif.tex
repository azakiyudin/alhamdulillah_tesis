...
Pada bagian ini, disajikan definisi, contoh, dan sifat-sifat dari pemetaan $(\alpha,\beta,\gamma)$-nonekspansif di ruang $CAT_p(0)$. Sifat yang didapatkan dari pemetaan ini disajikan dalam Lema \ref{lemma:tutx}, yang menunjukkan bahwa pemetaan ini memenuhi kondisi nonekspansif kuasi. 
Kemudian, pada Lema \ref{Lema:ineqabcnoneks} didapatkan ketaksamaan penting yang melibatkan pemetaan tersebut. Selain itu, didapatkan pula bahwa pemetaan ini memenuhi sifat \textit{demiclosedness} yang ditunjukkan oleh Lema \ref{Lema:demi}. Tiga Lema tersebut berperan penting untuk pembuktian konvergensi skema iterasi Sabri untuk aproksimasi titik tetap dari pemetaan $(\alpha,\beta,\gamma)$-nonekspansif. Pada bagian ini diberikan pula Teorema \ref{thm:titaptunggal} yang menyatakan syarat dari ketunggalan titik tetap dari pemetaan tersebut jika eksistensinya ada.
...
\begin{defn}\label{defn:abcnoncat}
    Diberikan $(X,d,G)$ adalah ruang $CAT _p(0)$ dan $W\subseteq X$ dengan $W\neq\emptyset$, pemetaan $f:W\to W$ disebut sebagai pemetaan $(\alpha,\beta,\gamma)$-nonekspansif jika terdapat bilangan real $\alpha,\beta,\gamma\in \mathbb{R}^+\cup\{0\}$ dengan $\alpha+\gamma\leq 1,\gamma\in[0,1)$ sehingga untuk setiap $x,y\in W$ berlaku
    \begin{align}
        d(Tx,Ty)\leq \alpha d(x,y)+\beta d(x,Tx)+\gamma d(x, Ty). \label{eq:abcnoncat}
    \end{align}
\end{defn}
% Diperhatikan bahwa dalam Definisi \ref{defn:abcnoncat} di ruang $CAT_p(0)$, nilai $\alpha+\gamma<1$, sehingga pemetaan nonekspansif klasik tidak termasuk ke dalam kelas pemetaan $(\alpha,\beta,\gamma)$-nonekspansif. Hal ini bertujuan untuk menjamin hasil konvergensi 
    ...
    \begin{exam}\label{con:abcnon}
        ...
        \begin{align*}
            ...
            \end{cases}
        \end{align*}
        Pemetaan $T$ adalah pemetaan $(\frac{1}{4},\frac{1}{3},0)$-nonekspansif, tetapi bukan pemetaan nonekspansif. Pemetaan $T$ mempunyai titik tetap yang tunggal, yaitu $(1,1,0,0,0,\dots)$.
    \end{exam}
    ...
    \end{align*}
    Dari (i) diperoleh $w_1=w_2=1\in [1,3)$, sedangkan dari (ii) diperoleh $w_1=\frac{2}{3}\notin [3,5]$. Karena $\alpha+\gamma<1$, didapatkan bahwa $T$ mempunyai titik tetap yang tunggal, yaitu $(1,1,0,0,\cdots)$.
    % \input{Bab_4/conpemet.tex}
    ...
    %         \end{align*}
    %         artinya $f(y_1,y_2)$ tidak mempunyai titik pelana. Walaupun begitu, $f(y_1,y_2)$ mempunyai titik kritis, yaitu saat $|4y_1-y_2-2|=0$ atau $|y_1-y_2+1|=0$. Hal ini berarti nilai minimumnya berada pada titik kritis atau pada titik-titik batas domainnya. 
    %         \begin{enumerate}
    ...
    Diberikan $(X,d,G)$ adalah ruang $CAT _p(0)$ dan $W\subseteq X$ dengan $W\neq\emptyset$, serta $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif. Jika $u$ adalah titik tetap dari $T$, maka untuk setiap $x\in W$ berlaku $d(Tx,Tu)\leq d(x,u)$. 
    \end{lemma}
    \begin{bukti}
    ...
    \begin{lemma}\label{Lema:ineqabcnoneks}
        Diberikan $(X,d,G)$ adalah ruang $CAT _p(0)$ dan $W\subseteq X$ dengan $W\neq\emptyset$, serta $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif. Untuk setiap $x,y\in W$, ketaksamaan berikut ini berlaku:
    ...
    \begin{lemma}\label{Lema:demi}
        Diberikan $(X,d,G)$ adalah ruang $CAT _p(0)$ dan $W\subseteq X$ dengan $W\neq\emptyset$. Jika $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif, maka $T$ mempunyai sifat \textbf{demiclosedness}. 
    \end{lemma}
    \begin{bukti}
        Diambil sebarang barisan $\{x_n\}_{n=1}^{\infty}\subseteq W$ yang terbatas dan konvergen-$\Delta$ ke $u_0\in W$, serta memenuhi $\lim_{n\to\infty} d(x_n,Tx_n)=0$. Berdasarkan definisi \ref{defn:konvD}, diperoleh bahwa $u_0\in A(\{x_n\}_{n=1}^{\infty})$. Kemudian, menggunakan ketaksamaan \eqref{eq:ineqabcnoneks}, didapatkan 
        \begin{align*}
        ...
        \end{align*}
        Hal ini berarti $Tu_0\in A(\{x_n\}_{n=1}^{\infty})$. Kemudian, berdasarkan Lema \ref{Lema:asimtotik}, dipunyai bahwa $A(\{x_n\}_{n=1}^{\infty})$ tepat mempunyai satu elemen, yang berarti $u_0=Tu_0$. Jadi $T$ mempunyai sifat \textbf{demiclosedness}. 
    \end{bukti}

Teorema berikut ini menyatakan ketunggalan titik tetap dari pemetaan $(\alpha,\beta,\gamma)$-nonekspansif.
    \begin{thm}\label{thm:titaptunggal}
        Diberikan $(X,d,G)$ adalah ruang $CAT_p(0)$ dan $W\subseteq X$ dengan $W\neq\emptyset$. Jika  $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif dengan $\alpha+\gamma\neq 1$ dan $T$ mempunyai titik tetap, maka titik tetap dari $T$ tunggal.
    \end{thm}
    \begin{bukti}
