...
\begin{defn}\label{defn:abcnoncat}
    Diberikan $(X,d)$ adalah ruang $CAT_p(0)$ dan $W$ adalah himpunan bagian tak kosong dari $X$, pemetaan $f:W\to W$ disebut sebagai pemetaan $(\alpha,\beta,\gamma)$-nonekspansif jika terdapat bilangan real $\alpha,\beta,\gamma\in \mathbb{R}^+\cup\{0\}$ dengan $\alpha+\gamma\leq 1,\gamma\in[0,1)$ sehingga untuk setiap $x,y\in W$ berlaku
    \begin{align}
...
\end{defn}
    ...
    \end{align}
    Didefinisikan pula jalur geodesik yang menghubungkan $w=(w_1,w_2,w_3,\dots)$ dan $z=(z_1,z_2,z_3,\dots)$, yaitu $\gamma:[0,1]\to X$ dengan $\gamma(t):=(1-t)w\oplus tz$ sebagai
    \begin{align}\label{eq:conGdsk}
    \gamma(t)=\big(\alpha_1(t), \alpha_1(t)^3-(1-t)(w_1^3-w_2)-t(z_1^3-z_2),\alpha_3(t),\alpha_4(t),\cdots\big),
    \end{align}
    ...
    \begin{align*}
        \gamma(0)=(w_1,w_2,w_3,\dots)=w \qquad \text{dan} \qquad \gamma(1)=(z_1,z_2,z_3\dots)=z.
    \end{align*}
    ...
    Didapatkan bahwa 
    \begin{align*}
d(\gamma(t),\gamma(s))&=\left(\sum_{i=1}^{\infty}|\beta_i(t,s)|^3\right)^{\frac{1}{3}}\\
        &= |s-t|d(w,z).
    \end{align*}
    Hal ini berarti $\gamma(t)$ merupakan geodesik pada $X$. Kemudian, untuk setiap segitiga geodesik $\triangle \in X$ dan $x=(x_1,x_2,x_3,\dots),y=(y_1,y_2,y_3,\dots)\in \triangle$, diperoleh bahwa terdapat segitiga komparasi $\overline{\triangle}\in \ell_3$ sehingga untuk setiap $\overline{x}=(x_1,x_1^3-x_2,x_3,\dots),\overline{y}=(y_1,y_1^3-y_2,y_3,\dots)\in \overline{\triangle}$ berlaku 
    \begin{align*}
    ...
    \begin{exam}\label{con:abcnon}
        Diberikan $(X,d)$ adalah ruang $CAT_p(0)$ sebagaimana dalam Contoh \ref{con:Catp}. Diberikan pula $W=\{(w_1,w_2,0,0,\cdots)\mid w_1\in[1,5], w_2\in[1,125]\}\subset X$. dan pemetaan $T:W\to W$ yang didefinisikan sebagai 
        \begin{align*}
    ...
    \end{exam}
        ...
        \begin{enumerate}[label={\textbf{Kasus \arabic*.}},align=left]
            ...
            \begin{align*}
                ...
                &+\frac{3}{4} \left(\left|u_1-\frac{v_1+3}{4}\right|^3+\bigg|u_1^3-u_2 -\qty(\frac{v_1+3}{4})^3+\frac{(v_1+3)^3}{64}\bigg|^3\right)^{\frac{1}{3}}\\
            ...
            \end{align*}
            artinya $f(u_1,v_1)$ tidak memiliki titik pelana. Walaupun begitu, $f(u_1,v_1)$ memiliki titik kritis, yaitu saat $|4u_1-v_1-2|=0$ atau $|u_1-v_1+1|=0$. Hal ini berarti nilai minimumnya berada pada titik kritis atau pada titik-titik batas domainnya. 
            \begin{enumerate}
    ...
    Diberikan $(X,d)$ adalah ruang $CAT_p(0)$ dan $W$ adalah himpunan bagian tak kosong dari $X$, serta $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif. Jika $u$ adalah titik tetap dari $T$, maka untuk setiap $x\in W$ berlaku $d(Tx,Tu)\leq d(x,u)$. 
    \end{lemma}
    \begin{bukti}
        ...
        Akibatnya
        \begin{align*}
           d(Tx,Tu)= d(Tu,Tx)= d(u, Tx) \leq \frac{\alpha}{1-\gamma} d(x,u) \leq d(x,u).
        \end{align*}
    \end{bukti}
    \begin{lemma}\label{Lema:ineqabcnoneks}
        Diberikan $(X,d)$ adalah ruang $CAT_p(0)$ dan $W$ adalah himpunan bagian tak kosong dari $X$, serta $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif. Untuk setiap $x,y\in W$, ketaksamaan berikut ini berlaku:
    ...
    \begin{lemma}\label{Lema:demi}
        Diberikan $(X,d)$ adalah ruang $CAT_p(0)$ dan $W$ adalah himpunan bagian tak kosong dari $X$. Jika $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif, maka $T$ memiliki sifat \textbf{demiclosedness}. 
    \end{lemma}
    \begin{bukti}
