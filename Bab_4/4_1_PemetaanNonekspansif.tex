...
Teorema berikut ini menyatakan ketunggalan titik tetap dari pemetaan $(\alpha,\beta,\gamma)$-nonekspansif.
    \begin{thm}\label{thm:titaptunggal}
        Diberikan $(X,d,G)$ adalah ruang $CAT_p(0)$ dan $W$ adalah himpunan bagian tak kosong dari $X$. Jika  $T:W\to W$ adalah pemetaan $(\alpha,\beta,\gamma)$-nonekspansif dengan $\alpha+\gamma\neq 1$ dan $T$ memiliki titik tetap, maka titik tetap dari $T$ tunggal.
    \end{thm}
    \begin{bukti}
