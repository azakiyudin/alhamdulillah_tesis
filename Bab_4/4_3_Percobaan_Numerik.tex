...
4 & NaN & (1.000001, 1.000003, 0, 0, \dots) \\
5 & NaN & (1.000000, 1.000000, 0, 0, \dots) \\
\hline
\end{tabular}
    \label{tab:sabjk}
\end{table}
...
4 & NaN & (1.000010, 1.000030, 0, 0, \dots) \\
5 & NaN & (1.000001, 1.000002, 0, 0, \dots) \\
\hline
\end{tabular}
    \label{tab:sabthkur}
\end{table}
...
4 & NaN & (1.000146, 1.000437, 0, 0, \dots) \\
5 & NaN & (1.000016, 1.000048, 0, 0, \dots) \\
6 & NaN & (1.000002, 1.000005, 0, 0, \dots) \\
7 & NaN & (1.000000, 1.000001, 0, 0, \dots) \\
\hline
\label{tab:sababb}
\end{longtable}
...
4 & NaN & (1.002590, 1.007789, 0, 0, \dots) \\
5 & NaN & (1.000584, 1.001754, 0, 0, \dots) \\
6 & NaN & (1.000132, 1.000395, 0, 0, \dots) \\
7 & NaN & (1.000030, 1.000089, 0, 0, \dots) \\
8 & NaN & (1.000007, 1.000020, 0, 0, \dots) \\
9 & NaN & (1.000002, 1.000005, 0, 0, \dots) \\
10 & NaN & (1.000000, 1.000001, 0, 0, \dots) \\
\hline
\end{tabular}
    \label{tab:sabag}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Bab_4/galatpercobaan.png}
    \caption{Galat $d(x_n,x^*)$ vs iterasi}
    \label{fig:galatperc}
\end{figure}
...
Hasil tersebut menunjukkan bahwa skema iterasi Sabri memiliki laju konvergensi yang lebih baik daripada yang lainnya secara numerik. Dengan parameter tertentu, skema tersebut hanya membutuhkan 7 iterasi untuk konvergen ke titik tetapnya dengan galat kurang dari $10^{-16}$. 
