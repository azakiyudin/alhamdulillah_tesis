...
Untuk selanjutnya, dinotasikan $W$ sebagai himpunan bagian tak kosong yang konveks dari ruang $CAT_p(0)$ $(X,d,G)$, serta $Fix(T)$ adalah himpunan yang berisi titik tetap dari pemetaan $T$.
...
\begin{bukti}
    Diambil sebarang $x^*\in Fix(T)$, berdasarkan Lema \ref{lema:d,d^p} dan \ref{lemma:tutx}, didapatkan bahwa
    \begin{align*}
        d^p(q_n,x^*) &= d^p\qty(T\qty((1-c_n)x_n\oplus c_n Tx_n),x^*)\\
        &\leq d^p\qty((1-c_n)x_n\oplus c_nTx_n,x^*)\\
        &\leq (1-c_n)d^p(x_n,x^*)+c_n d^p(Tx_n,x^*)-\frac{c_n(1-c_n)}{2^{p-1}}d^p(x_n,Tx_n).
    \end{align*}
    Karena $a\leq c_k\leq b$, diperoleh $-c_n(1-c_n)\leq a(1-b)$ sehingga 
    \begin{align*}
        d^p(q_n,x^*)&\leq (1-c_n)d^p(x_n,x^*)+c_n d^p(x_n,x^*)-\frac{a(1-b)}{2^{p-1}} d^p(x_n,Tx_n)\\
    ...
    \begin{align*}
        ...
        \leq&~ (1-a_n)d^p(Tq_n,x^*)+a_n d^p(Ty_n,x^*)-\frac{c_n(1-c_n)}{2^{p-1}}d^p(Tq_n,Ty_n)\\
    ...
    \end{align*}
    Selanjutnya, berdasarkan Lema \ref{Lema:dxnx*}, diperoleh bahwa $\{d(x_n,x^*)\}$ adalah barisan turun dan terbatas di bawah dengan batas bawah 0, sehingga $\{d(x_n,x^*)\}$ konvergen. Hal ini berarti $u_n = d^p(x_n,x^*)$ juga konvergen dan diperoleh $\lim_{n\to\infty} (u_n-u_{n+1})=0$. Akibatnya, didapatkan 
    \begin{align*}
